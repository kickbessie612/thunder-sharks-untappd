...
def seed_beers():
    beer1 = Beer(
        ...
        abv=6, ibu=-1, style='IPA - American', year=0, label='https://assets.untappd.com/site/beer_logos_hd/beer-3362046_f0bd5_hd.jpeg', user_id=1, brewery_id=1)
    ...
    beer2 = Beer(
        ...
        abv=13, ibu=-1, style='Stout - Imperial / Double', year=2016, label='https://assets.untappd.com/site/beer_logos_hd/beer-131332_040df_hd.jpeg', user_id=2, brewery_id=2)
    ...
    beer4 = Beer(
        ...
        abv=12.8, ibu=-1, style='Stout - Imperial / Double', year=2014, label='https://assets.untappd.com/site/beer_logos_hd/beer-763835_fa3da_hd.jpeg', user_id=1, brewery_id=4)
    ...
    beer6 = Beer(
        ...
        abv=15, ibu=-1, style='Stout - Russian Imperial', year=2016, label='https://assets.untappd.com/site/beer_logos_hd/beer-1529002_75107_hd.jpeg', user_id=3, brewery_id=6)
