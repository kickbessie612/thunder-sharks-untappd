...
def seed_beers():
    beer1 = Beer(
        ...
        abv=6, ibu=-1, style='IPA - American', year=0, label='https://assets.untappd.com/site/beer_logos/beer-3362046_f0bd5_sm.jpeg', user_id=1, brewery_id=1)
    ...
    beer2 = Beer(
        ...
        abv=13, ibu=-1, style='Stout - Imperial / Double', year=2016, label='https://assets.untappd.com/site/beer_logos/beer-131332_2a8ab_sm.jpeg', user_id=2, brewery_id=2)
    ...
    beer3 = Beer(
        ...
        abv=8.4, ibu=65, style='Stout - Imperial / Double', year=0, label='https://assets.untappd.com/site/beer_logos/beer-808915_7e795_sm.jpeg', user_id=3, brewery_id=3)
