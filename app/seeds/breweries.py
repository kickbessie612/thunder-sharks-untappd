...
def seed_breweries():
    ...
    brewery4 = Brewery(user_id=1,
                       ...
                       description='Named 2021 US Beer Open Grand National Champions. Founded in 2009 in beautiful Decorah, Iowa. World-renown for IPAs and barrel-aged stouts, distributing to over 30 states and brewing more than 35 beers. ',
                       picture='https://beerpulse.com/wp-content/uploads/2013/07/tree-house-brewing-square-logo1.jpg')
